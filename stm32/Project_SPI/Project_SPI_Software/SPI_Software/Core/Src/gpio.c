...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, SPI_CS_Pin|SPI_SCL_Pin|SPI_DI_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, OLED_SCL_Pin|OLED_SDA_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : SPI_CS_Pin SPI_SCL_Pin SPI_DI_Pin */
  GPIO_InitStruct.Pin = SPI_CS_Pin|SPI_SCL_Pin|SPI_DI_Pin;
